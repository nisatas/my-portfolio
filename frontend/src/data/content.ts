...
export const content: Record<Lang, any> = {
  tr: {
      ...
      items: [
        {
          ...
          image: "/src/assets/certificate-ai-weekend.jpg", // Sertifika görselini src/assets klasörüne ekleyip buraya yolunu yazın, örn: "/src/assets/certificate-ai-weekend.jpg"
        },
      ],
    },
    projects: {
      ...
      items: [
        ...
        {
          name: "Voice AI — Otonom Sesli Resepsiyon",
    ...
    skillMap: {
      ...
      islands: [
        { id: "react", label: "React", ability: "UI bileşenleri, hooks, state", type: "frontend" },
        { id: "javascript", label: "JavaScript", ability: "ES6+, async, DOM", type: "frontend" },
        { id: "java", label: "Java", ability: "Spring Boot, OOP", type: "backend" },
        ...
        { id: "vr", label: "VR / XR", ability: "Sanal gerçeklik deneyimleri", type: "other" },
  ...
  en: {
      ...
      items: [
        {
          ...
          image: "/src/assets/certificate-ai-weekend.jpg", // Add certificate image path here, e.g., "/src/assets/certificate-ai-weekend.jpg"
        },
      ],
    },
    projects: {
      ...
      items: [
        ...
        {
          name: "Voice AI — Autonomous Voice Receptionist",
    ...
    skillMap: {
      ...
      otherList: "Algorithms, Debugging, Deployment, Problem Solving, API Integration, Figma, Teamwork",
      islands: [
        { id: "react", label: "React", ability: "UI components, hooks, state", type: "frontend" },
        { id: "javascript", label: "JavaScript", ability: "ES6+, async, DOM", type: "frontend" },
        { id: "java", label: "Java", ability: "Spring Boot, OOP", type: "backend" },
        { id: "sql", label: "SQL", ability: "Database design & queries", type: "backend" },
        { id: "git", label: "Git", ability: "Version control, teamwork", type: "tool" },
        { id: "vr", label: "VR / XR", ability: "Virtual reality experiences", type: "other" },
